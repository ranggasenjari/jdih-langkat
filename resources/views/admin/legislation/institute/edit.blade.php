...
<form id="update-institute-form" action="{{ route('admin.legislation.institute.update', $institute->id) }}" method="post">
    ...
    <div class="modal-body">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="name" id="name" value="{{ $institute->name }}" placeholder="Bagian Hukum Setda Kab. Langkat">
        </div>
        <div class="mb-3">
            <label for="abbrev" class="form-label">Singkatan</label>
            <input type="text" class="form-control" name="abbrev" id="abbrev" value="{{ $institute->abbrev }}" placeholder="BAGIAN HUKUM">
        </div>
        <!-- <div class="mb-3">
