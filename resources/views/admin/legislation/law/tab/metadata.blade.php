<div class="card-body">
    ...
    <div class="alert alert-info border-0">
        Penjelasan dan pedoman tata cara penulisan metadata peraturan dapat dilihat pada <a href="{{ url('/produk-hukum/dokumen-peraturan/permenkumham/24804') }}">Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen dan Informasi Hukum</a>.
    </div>
    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="location" id="location" class="form-control @error('location') is-invalid @enderror" value="{{ old('location', empty($law) ? 'Bag. Hukum Kab. Langkat' : $law->location) }}">
            ...
            <div class="mb-3">
                ...
                <div class="form-text text-muted">Berdasarkan <a href="{{ url('/produk-hukum/dokumen-peraturan/pp/13250') }}">Peraturan Pemerintah Nomor 38 Tahun 2007</a>. Contoh: Pemberdayaan Perempuan dan Perlindungan Anak.
                    @cannot('isAuthor')
