                ...
                <div class="flex-1 order-2 order-lg-1">
                    ...
                    <div class="card card-body">
                        <div class="alert alert-info border-0">
                            Penjelasan dan pedoman tata cara penulisan metadata putusan dapat dilihat pada <a href="{{ url('/produk-hukum/dokumen-peraturan/permenkumham/24804') }}">Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen dan Informasi Hukum</a>.
                        </div>
                                    ...
                                    <div class="form-check-horizontal">
                                        @foreach ($judgmentStatusOptions as $status)                        
                                            <label class="form-check form-check-inline">
                                                <input type="radio" class="form-check-input" name="status" value="{{ $status->value }}" @checked($judgment->status == $status)>
