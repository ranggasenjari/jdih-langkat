...
<form action="{{ route('admin.legislation.category.update', $category->id) }}" method="post">
    ...
    <div class="modal-body">
        ...
        <div class="mb-0">
            ...
            <textarea name="desc" id="desc" class="form-control" rows="4" placeholder="Dokumen Peraturan yang dibentuk oleh Dewan Perwakilan Rakyat Daerah dengan persetujuan bersama Kepala Daerah (gubernur atau bupati/wali kota)">{{ $category->desc }}</textarea>
        </div>
    </div>
