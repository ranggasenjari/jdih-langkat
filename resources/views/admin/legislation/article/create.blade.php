                ...
                <div class="flex-1 order-2 order-lg-1">
                    ...
                    <div class="card card-body">
                        <div class="alert alert-info border-0">
                            Penjelasan dan pedoman tata cara penulisan metadata artikel dapat dilihat pada <a href="{{ url('/produk-hukum/dokumen-peraturan/permenkumham/24804') }}">Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen dan Informasi Hukum</a>.
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="mb-3">
                                    <label class="col-form-label" for="category_id">Jenis Artikel <span class="text-danger">*</span></label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">Tempat fisik artikel disimpan. Contoh: Sekretariat Daerah.</div>
                                    @error('location')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-text text-muted">Format penulisan: Nama pengarang (tanpa gelar dan dibalik). Contoh: RANGGA, SENJARI.</div>
                                    @error('author')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
