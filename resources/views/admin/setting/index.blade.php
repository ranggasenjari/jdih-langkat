                            ...
                            <fieldset>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="form-text text-muted">Kode wilayah dapat dilihat pada <a href="{{ url('/produk-hukum/dokumen-peraturan/permenkumham/24804') }}">Peraturan Menteri Hukum dan Hak Asasi Manusia Nomor 8 Tahun 2019 tentang Standar Pengelolaan Dokumen dan Informasi Hukum</a>.</span>
                                        @error('region_code')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
