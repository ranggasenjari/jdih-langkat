...
<div class="card shadow mb-4">
    ...
    <form class="filter-form"
        @isset($category)
            action="{{ route('legislation.monograph.category', ['category' => $category->slug]) }}"
        @else
            action="{{ route('legislation.monograph.index') }}"
        @endisset
        method="get">
            ...
            <div class="collapse show" id="catalogue">
                <div class="sidebar-section-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="publisher" type="search" name="publisher" class="form-control" placeholder="Contoh: Sinar Grafika" value="{{ Request::get('publisher') }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">ISBN:</label>
                        <input id="isbn" type="search" name="isbn" class="form-control" placeholder="Contoh: 413514558" value="{{ Request::get('isbn') }}">
                    </div>
                    <div class="mb-3">
