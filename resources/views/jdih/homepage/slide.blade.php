        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade overlay" data-bs-ride="carousel">
            <div class="carousel-inner">
                @foreach ($slides as $slide)
                    <div class="carousel-item @if ($loop->first) active @endif" style="background-image: url({{ $slide->image->source ?? '' }}); background-position:{{ $slide->position }}; min-height: 380px"></div>
                @endforeach
            </div>
        </div>
    @else
                ...
                <div class="row gx-7">
                    <div class="col-xl-6 m-auto">
                        <h2 class="fw-bold mt-5 text-white display-6">
                            ...
                            <span id="first-typer" class="typer fw-bold text-nowrap text-danger display-6" data-delay="100" data-words="peraturan,monografi hukum,artikel hukum,perjanjian kerjasama">peraturan</span>
