@if($isMobile)
<aside class="d-flex col-xl-1 text-center">
@else
...
@endif
    ...
    <div class="post-view my-4 flex-fill">
    ...
    @isset($download)
        <div class="post-download my-4 flex-fill">
            <div class="bg-dark bg-opacity-10 text-dark lh-1 rounded-pill p-2 d-inline-block mb-1">
    ...
    @endisset
    <div class="post-bookmark my-4 flex-fill">
    ...
    <div class="post-share my-4 flex-fill">
        <div class="btn-group">
