            ...
            <div class="content py-4">
                <div class="row gx-5">
                    <div class="col-lg-4 fs-md">
                        ...
                        {!! $welcome->excerpt ?? '' !!}
                        <a href="https://play.google.com/store/apps/details?id=id.go.langkatkab.jdih.twa" target="_blank">
                        <img width="230" class="rounded img-fluid my-2" src="{{ asset('assets/admin/images/logo-playstore.png') }}">
                        </a>
                    </div>
                    <div class="col-lg-2">
